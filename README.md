...
#had a hard time problem solving for this bug. Kept getting rollback and no save. Tried solving useing error.full_messages. Not sure if it was a problem with params or what..
